...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: Clicking padding only focuses the input, which is already keyboard reachable via Tab.
    // biome-ignore lint/a11y/noStaticElementInteractions: This wrapper only expands the input focus target; nested buttons remain interactive.
    <div
